...
public class VehicleSpawner extends Actor
{
    ...
    public VehicleSpawner (boolean rightward, int laneHeight, int laneNumber)
    {
        ...
        // and then false to hide them at the end to make your project look clean.
        boolean visible = VehicleWorld.SHOW_SPAWNERS;
    ...
    /**
     * Returns true when the spawner area is still occupied by a Vehicle.
