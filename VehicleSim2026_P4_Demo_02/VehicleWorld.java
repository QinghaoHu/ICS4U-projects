 ...
 * <p> The Pedestrians are not as dumb as before (they don't walk straight into Vehicles) and the Vehicles
...
public class VehicleWorld extends World {
    ...
    private final Windstorm windstorm;
    ...
    private final int actsBetweenRain;
    ...
    public VehicleWorld() {
        ...
        isRaining = false;
        actsBetweenRain = Integer.MAX_VALUE;
        rainDuration = 240;
        rainCountdown = actsBetweenRain;

        windstorm = new Windstorm();
...
//            target.fillRect(0, lanePositions[i] + heightOffset, target.getWidth(), spacing);
    ...
    private void spawn() {
        ...
        if (rainCountdown == 0) {
            if (isRaining) {
                removeObject(windstorm);
                isRaining = false;
                rainCountdown = actsBetweenRain;
            } else {
                addObject(windstorm, getWidth() / 2, getHeight() / 2);
                isRaining = true;
                rainCountdown = rainDuration;
            }
        }
